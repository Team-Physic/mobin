...
- 작성일: 2026-08-07
- 대상: TurtleBot3 simulation과 LiDAR-Camera calibration source
- 확인 기준: local fork clone, upstream repository, license 원문
- 결론: **두 source를 독립 fork로 관리하면 직접 수정·push할 수 있다. 단, 재배포 시 각 upstream과 nested dependency의 license 고지를 유지해야 한다.**
...
git -C forks/turtlebot3_simulations push -u origin practice/add-3d-lidar
```
